      ...
      >
        ...
        <div className="text-center mb-8">
          <motion.div
            ...
            className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-[#00d4ff] to-[#7c3aed] flex items-center justify-center"
          >
            <Sparkles className="w-8 h-8 text-white" />
          </motion.div>
          <h1 className="text-3xl font-bold gradient-text">Welcome Back</h1>
          <p className="text-[var(--color-text-muted)] mt-2">
            Sign in to your LifeLens AI account
          </p>
        </div>
